                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">{{__('Create Country')}}</h5>
                        </div>
                        <div class="card-body">
                            <form id="mainAdd" method="post" action="javascript:void(0)" >
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="iso" id="iso" placeholder="{{__('iso')}}" required>
                                </div>

                                <div class="form-group mb-3">
                                    <label class="form-label" for="facebook">{{__('iso3')}}</label>
                                    <input type="text" class="form-control" name="iso3" id="iso3" placeholder="{{__('iso3')}}" >
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label" for="twitter">{{__('currency')}}</label>
                                    <input type="text" class="form-control" name="currency" id="currency" placeholder="{{__('currency')}}" >
                                </div>

                                <div class="form-group mb-3">
                                    <label class="form-label" for="phone_code">{{__('phone code')}}</label>
                                    <input type="text" class="form-control" name="phone_code" id="phone_code" placeholder="{{__('phone_code')}}" >
                                </div>
...
@section('scripts')
    ...
    <script>
        ...
        var data_url='{{ route('admin.countries.store')}}'
