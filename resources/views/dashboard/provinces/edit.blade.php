            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">{{__('Edit Province')}}</h5>
                    </div>
                    <div class="card-body">
                                            ...
                                            <div id="accordion{{ $locale }}" class="accordion-collapse collapse @if ($index === 0) show @endif" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="title[{{ $locale }}]"  value="{{ $province->getTranslation('title', $locale) }}" id="title_{{ $locale }}" placeholder="{{ __('Title in ') . strtoupper($locale) }}" required>
                                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        var data_url='{{ route('admin.provinces.update',$province->id)}}'
