    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{__('Contact Reply')}}</li>
                <!-- Basic table -->
            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">{{__('Contact Reply')}}</h5>
                    </div>
                    <div class="card-body">
{{--                        <form id="mainAdd" method="post" action="javascript:void(0)" >--}}
                            <div class="form-group mb-3">
                                <label class="form-label" for="name">{{__('Name')}}</label>
                                <input type="text" class="form-control" name="name" id="name" disabled value="{{$contact->name}}" placeholder="{{__('Name')}}" required>
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="code">{{__('Phone')}}</label>
                                <input type="text" class="form-control" name="code" id="code" disabled value="{{$contact->phone}}" placeholder="{{__('Phone')}}" required>
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="code">{{__('Email')}}</label>
                                <input type="text" class="form-control" name="code" id="code" disabled value="{{$contact->email}}" placeholder="{{__('Email')}}" required>
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="code">{{__('Subject')}}</label>
                                <input type="text" class="form-control" name="code" id="code" disabled value="{{$contact->subject}}" placeholder="{{__('Email')}}" required>
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="message">{{__('message')}}</label>
                                <textarea name="message" class="form-control"  id="message" disabled rows="10">{{$contact->message}}</textarea>
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        var data_url='{{ route('contact.send_reply',$contact->id)}}'
