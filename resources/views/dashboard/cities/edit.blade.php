    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{route('admin.cities.index',$country->id)}}">{{$country->name}}|{{__('Cities')}}</a>
                    ...
                    <div class="card-body">
                        <form id="mainAdd" method="post" action="javascript:void(0)" >
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value="{{$city->name}}" placeholder="{{__('Name')}}" required>
                            </div>
                            <div class="form-group  mb-3">
...
@section('scripts')
    ...
    <script>
        ...
        var data_url='{{ route('admin.cities.update',$city->id)}}'
