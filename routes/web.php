...
Route::group(['prefix' => LaravelLocalization::setLocale()], function()
{
    ...
    Route::get('/jordan/governorates', [MainController::class, 'getGovernorates'])->name('admin.jordan.governorates');
    Route::get('/jordan/departments/{governorate_id}', [MainController::class, 'getDepartments'])->name('admin.jordan.departments');
    Route::get('/jordan/villages/{department_id}', [MainController::class, 'getVillages'])->name('admin.jordan.villages');
    Route::get('/jordan/hods/{department_id}/{village_id}', [MainController::class, 'getHods'])->name('admin.jordan.hods');
    Route::get('/jordan/hays/{department_id}/{village_id}/{hod_id}', [MainController::class, 'getHays'])->name('admin.jordan.hays');
