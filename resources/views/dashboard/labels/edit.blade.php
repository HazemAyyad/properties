...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                    <li class="nav-item ">
                        <a class="nav-link active" href="{{route('shipment_form.edit',$shipment_form->id)}}"><i class="fa-regular fa-pen-to-square me-1"></i> Edit</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('shipment_form.labels',$shipment_form->id)}}"><i class="fa-solid fa-barcode me-1"></i> Labels</a>
                    </li>
        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="javascript:void(0)" id="shipment_form" name="shipment_form">
                            ...
                            <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-12 col-md-12 col-lg-12 form-info">
                                                                <div class="mb-2">
                                                                    <label
                                                                        for="editable-select">{{ __('Name') }}</label>

                                                                    <input type="text" class="form-control"
                                                                        name="s_name" value="{{ $shipment_form->s_name }}"
                                                                        id="s_name" autocomplete="no_name" required>
                                                            ...
                                                            <div class="col-12 col-md-12 col-lg-12 form-info">
                                                                <div class="mb-2">
                                                                    ...
                                                                    <select required
                                                                        ...
                                                                        id="s_country" name="s_country">
                                                                        @if ($countries)
                                                                            <option></option>
                                                                            @foreach ($countries as $country)
                                                                                <option value="{{ $country->Country }}"
                                                                                    @if ($shipment_form->s_country === $country->Country) selected @endif>
                                                            ...
                                                            <div class="col-12 col-md-12 col-lg-12 form-info">
                                                                <div class="mb-2">
                                                                    <label>{{ __('City') }}</label>
                                                                    <input type="text" class="form-control"
                                                                        id="s_city" name="s_city"
                                                                        value="{{ $shipment_form->s_city }}" required />
                                                                </div>
                                                            ...
                                                            <div class="col-12 col-md-6 col-lg-6 form-info">
                                                                <div class="mb-2">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="s_state"
                                                                        value="{{ $shipment_form->s_state }}"
                                                                        name="s_state" required />
                                                                </div>
                                                            ...
                                                            <div class="col-12 col-md-6 col-lg-6 form-info">
                                                                <div class="mb-2">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="s_code" value="{{ $shipment_form->s_code }}"
                                                                        name="s_code" required />
                                                                </div>
                                                            ...
                                                            <div class="col-12 col-md-12 col-lg-12 form-info">
                                                                <div class="mb-2">
                                                                    ...
                                                                    <input type="number" class="form-control"
                                                                        id="s_phone"
                                                                        value="{{ $shipment_form->s_phone }}"
                                                                        name="s_phone" required />
                                                                </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-12 col-md-12 col-lg-12 form-info">
                                                                <div class="mb-2">
                                                                    <label
                                                                        for="editable-select-1">{{ __('Name') }}</label>

                                                                    <input type="text" class="form-control"
                                                                        name="r_name" id="r_name"
                                                                        autocomplete="no_name"
                                                                ...
                                                                <div class="mb-2">
                                                                    ...
                                                                    <select required
                                                                        ...
                                                                        @if ($countries)
                                                                            ...
                                                                            @foreach ($countries as $country)
                                                                                <option value="{{ $country->Country }}"
                                                                                    @if ($shipment_form->r_country === $country->Country) selected @endif>
                                                                                    {{ $country->Country }}</option>
                                                                            @endforeach
                                                                        @endif
                                                                    </select>
                                                            ...
                                                            <div class="col-12 col-md-6 col-lg-6 form-info">
                                                                <div class="mb-2">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="r_state"
                                                                        value="{{ $shipment_form->r_state }}"
                                                                        name="r_state" required />
                                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-md-4 col-lg-4 form-info">
                                                                <div class="mb-2">
                                                                    <label
                                                                        for="pickup_date">{{ __('Pickup Date') }}</label>
                                                                    <div class="input-group">
                                                                        <input type="text"
                                                                            class="form-control docs-date flat_date"
                                                                            name="pickup_date"
                                                                            value="{{ $shipment_form->pickup_date }}"
                                                                            id="" placeholder="Pick a date">
                                ...
                                <hr>
                                <button type="submit" id="send" style="width:30%; margin:auto"
    ...
    <!-- / Content -->
    <div class="modal fade" id="newItem" tabindex="-1" role="dialog" aria-labelledby="basicModal"
        aria-hidden="true">
                            ...
                            <div class="section col-md-12">
                                <div class="row">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="input-group-prepend dropdown">
                                                    ...
                                                    <div class="dropdown-menu" style="width: 50%;">
                                                        ...
                                                        <input type="text" name="unit_weight" id="unit_weight"
                                                            value="lbs" hidden>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12 col-md-12 col-lg-12 form-info" id="dimension">
                                        ...
                                        <a href="#" class="btn btn-danger remove hidden" id="remove"><i
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-4 col-lg-4 form-info">
                                                    <div class="mb-2">
                                                        ...
                                                        <input type="text" class="form-control item-content"
                                                            id="content" name="items[0][content]" required />
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="number" min="0"
                                                                class="form-control item-value" id="value"
                                                                onchange="calculate_total(0)" name="items[0][value]"
                                                ...
                                                <div class="col-12 col-md-2 col-lg-2 form-info">
                                                    <div class="mb-2">
                                                        ...
                                                        <input type="number" min="0"
                                                            class="form-control item-quantity" id="quantity"
                                                            onchange="calculate_total(0)" name="items[0][quantity]"
                                                            required />
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-6  ">
                                <div class="mb-2">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" min="0" class="form-control" id="insurance"
                                            name="insurance" value="0" aria-label=""
                            ...
                            <div class="col-12 col-md-6 col-lg-6  ">
                                <div class="mb-2">
                                    ...
                                    <input id="final_total" name="final_total" type="text" readonly
                                        class="form-control ">
    ...
    <div class="modal fade" id="updateItem" tabindex="-1" role="dialog" aria-labelledby="basicModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content modal-video">
                <div class="modal-header text-center" style="border-bottom: 0px;">
                    <div class="row" style="width: 100%;">
                        <div class="col-12 text-center">
                            <h4 class="modal-title text-center fw-bold" id="myModalLabel">{{ __('Update Package') }}</h4>
                        </div>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-body  ">
                    ...
                    <form action="javascript:void(0)" id="form_update_package" name="form_update_package">
                                ...
                                <div class="row">
                                    ...
                                    <div id="sections_items" class="col-12 col-md-12 col-lg-12 form-info">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-2 col-lg-2 form-info">
                                                    <div class="mb-2">
                                                        ...
                                                        <input type="number" min="0"
                                                            class="form-control item-quantity" id="quantity"
                                                            onchange="update_calculate_total(0)" name="items[0][quantity]"
                                                            required />
                                                ...
                                                <div class="col-12 col-md-1 col-lg-1 form-info">
                                                    <div class="mb-2">
                                                        <label style="opacity: 0;"> </label>
                                                        <a href="#" class="btn btn-danger removeItemUpdate hidden"
                                                            id="removeItem" data-total="0"><i class="fa fa-trash"
                                                                aria-hidden="true"></i></a>
                                                    </div>
                                        ...
                                        <div class="btn_item">
                                            ...
                                            <div class="package">
                                                <a href="javascript:;" class="addsectionItemUpdate" id="addNewItemUpdate"
                                                    style="color: #e2342b;"><br />
                                                    <button type="submit"
                                                        class="btn btn-success waves-effect waves-light">
                                                        {{ __('Add Another Item') }}
        ...
        $(function() {
            jQuery.validator.setDefaults({
                ...
                errorPlacement: function(error, element) {
                    if (element.parent().hasClass('input-group')) {
                        ...
                        error.insertAfter(element.parent());
                    } else if (element.parent().hasClass('custom-checkbox')) {
                        error.insertAfter(element.parent());
            ...
            $("form[name='shipment_form']").validate({
                ...
                messages: {
                    ...
                    'package_details*': "Please enter your content",
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#shipment_form").submit(function() {
                let myform = $('#shipment_form');

                if (!myform.valid()) {
                    return false
                };
                if (myform.valid()) {
                    var postData = new FormData($('form#shipment_form')[0]);
                    $.ajaxSetup({
                        headers: {
                    ...
                    postData.append('packages', localStorage.getItem('packages'));

                    $.ajax({
                        url: '{{ route('shipment_form.update', $shipment_form->id) }}',
                        type: "POST",
                        data: postData,
                        processData: false,
                        contentType: false,
        ...
        $(document).ready(function() {
            ...
            $("#form_add_package").submit(function() {
                ...
                if (myform_add.valid()) {
                    ...
                    refreshTable();
                    swal.fire("Success", '{{ __('Done.') }}', "success");
                    $('#newItem').modal('hide')
                }
            });
            ...
            $("#form_update_package").submit(function() {
                ...
                if (!isNaN(updateIndex) && updateIndex >= 0 && updateIndex < packagesArray.length) {
                    ...
                    swal.fire("Success", '{{ __('Updated successfully.') }}', "success");
                } else {
            ...
            refreshTable();
            @if (count($shipment_form->packages) > 0)
            localStorage.removeItem('packages');
            @foreach ($shipment_form->packages as $package)
            // Call the function to add package data from the server to local storage
            addPackageToLocalStorage(@json($package));
            @endforeach
            @endif
            // Function to add package data to local storage
            function addPackageToLocalStorage(packageData) {
                // Capture the items dynamically
                var dynamicItems = [];
                packageData.shipments_form_items.forEach(function(item) {
                    var itemData = {
                ...
                // Create an object called `formData`
                var new_formData = {
                    pkg_type: packageData.pkg_type,
                    weight: packageData.weight,
                    unit_weight: packageData.unit_weight,
                    unit_height: packageData.unit_height,
                    height: packageData.height,
                    width: packageData.width,
                    length: packageData.length,
                    insurance: packageData.insurance,
                    final_total: packageData.final_total,
                    items: dynamicItems
                };
