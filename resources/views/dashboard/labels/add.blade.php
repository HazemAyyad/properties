                    ...
                    <div class="card-body">
                        <form id="mainAdd" method="post" action="javascript:void(0)" >
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="url" id="url" placeholder="{{__('URL')}}" required>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea  id="description_{{$item}}" name="description_{{$item}}"></textarea>
                            </div>
                            @endforeach
                            <div class="form-group  mb-3">
...
@section('scripts')
    ...
    <script>
        ...
        var data_url='{{ route('blogs.store')}}'
        ...
        $(document).ready(function() {
            ...
            $(document).on("click", "#add_form", function() {
                ...
                if (form.valid()) {
                    ...
                    @foreach($lang as $item)
                    postData.append('description_{{$item}}', CKEDITOR.instances['description_{{$item}}'].getData());
                    @endforeach
                    $('#add_form').html('');
