    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('Edit Goal') }}</li>
            </ol>
        </nav>
                    ...
                    <div class="card-body">
                        <form id="mainAdd" method="post" action="javascript:void(0)">
                                                ...
                                                <div class="accordion-body">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               name="title[{{ $locale }}]"
                                                               id="title_{{ $locale }}"
                                                               value="{{ $goal->getTranslation('title', $locale) }}"
                                                               required>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <textarea class="form-control"
                                                                  ...
                                                                  rows="3">{{ $goal->getTranslation('description', $locale) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                @if($goal->icon)
                                    <div class="mb-2">
                                        ...
                                        @endphp
                                        <img src="{{ $correctedImagePath }}" alt="icon" style="height: 50px; width: 50px;">
                                    </div>
                                @endif
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" name="sort_order" id="sort_order" value="{{ $goal->sort_order }}" min="0">
                            </div>

                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ $goal->is_active ? 'checked' : '' }}>
...
@section('scripts')
    ...
    <script>
        var data_url = '{{ route('admin.vision_goals.update', $goal->id) }}';
