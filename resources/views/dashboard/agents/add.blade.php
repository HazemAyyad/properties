        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{__('Create Agent')}}</li>
                    <!-- Basic table -->
                        ...
                        <div class="card-body">
                            <form id="mainAdd" method="post" action="javascript:void(0)" >
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="facebook" id="facebook" placeholder="{{__('Facebook')}}" >
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label" for="twitter">{{__('Twitter')}}</label>
                                    <input type="text" class="form-control" name="twitter" id="twitter" placeholder="{{__('Twitter')}}" >
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label" for="instagram">{{__('Instagram')}}</label>
                                    <input type="text" class="form-control" name="instagram" id="instagram" placeholder="{{__('Instagram')}}" >
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label" for="linkedin">{{__('LinkedIn')}}</label>
                                    <input type="text" class="form-control" name="linkedin" id="linkedin" placeholder="{{__('LinkedIn')}}" >
                                </div>
                                <div class="form-group mb-3">
...
@section('scripts')
    ...
    <script>
        ...
        var data_url='{{ route('admin.agents.store')}}'
