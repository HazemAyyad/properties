(function (global, factory) {
            ...
            validate: function validate(e) {
                ...
                if (n) {
                    ...
                    if (e.options.maxTotalSize && a > parseInt("".concat(e.options.maxTotalSize), 10)) {
                        return {
                            meta: Object.assign({}, {error: "INVALID_MAX_TOTAL_SIZE", totalSize: a}, r),
                            valid: false
                        }
                    }
                    if (e.options.minTotalSize && a < parseInt("".concat(e.options.minTotalSize), 10)) {
                        return {
                            meta: Object.assign({}, {error: "INVALID_MIN_TOTAL_SIZE", totalSize: a}, r),
                            valid: false
                        }
                    }
                } else {
    ...
    var l$1 = function () {
        ...
        _createClass(l, [{
            ...
            key: "off", value: function off(e, t) {
                this.ee.off(e, t);
                return this
            }
        }, {
            key: "emit", value: function emit(e) {
                var _this$ee;
            ...
            key: "deregisterPlugin", value: function deregisterPlugin(e) {
            ...
            key: "registerValidator", value: function registerValidator(e, t) {
            ...
            key: "registerFilter", value: function registerFilter(e, t) {
                this.filter.add(e, t);
                return this
            }
        }, {
            key: "deregisterFilter", value: function deregisterFilter(e, t) {
                this.filter.remove(e, t);
                return this
            }
        }, {
            key: "executeFilter", value: function executeFilter(e, t, i) {
                return this.filter.execute(e, t, i)
            }
        }, {
            key: "addField", value: function addField(e, t) {
            ...
            key: "removeField", value: function removeField(e) {
                if (!this.fields[e]) {
            ...
            key: "validateField", value: function validateField(e) {
                var _this2 = this;
            ...
            key: "validateElement", value: function validateElement(e, t) {
                var _this3 = this;
            ...
            key: "executeValidator", value: function executeValidator(e, t, i, s) {
                var _this4 = this;
            ...
            key: "getElementValue", value: function getElementValue(e, t, s) {
            ...
            key: "getFields", value: function getFields() {
                return this.fields
            }
        }, {
            key: "getFormElement", value: function getFormElement() {
                return this.form
            }
        }, {
            ...
            key: "getPlugin", value: function getPlugin(e) {
                return this.plugins[e]
            }
        }, {
            key: "updateFieldStatus", value: function updateFieldStatus(e, t, i) {
                var _this5 = this;
            ...
            key: "updateElementStatus", value: function updateElementStatus(e, t, i, s) {
                var _this6 = this;
            ...
            key: "resetForm", value: function resetForm(e) {
                var _this7 = this;
            ...
            key: "resetField", value: function resetField(e, t) {
                if (t) {
            ...
            key: "revalidateField", value: function revalidateField(e) {
                if (!this.fields[e]) {
                    return Promise.resolve("Ignored")
                }
                this.updateFieldStatus(e, "NotValidated");
            ...
            key: "disableValidator", value: function disableValidator(e, t) {
                if (!this.fields[e]) {
                    return this
                }
                var i = this.elements[e];
            ...
            key: "enableValidator", value: function enableValidator(e, t) {
                if (!this.fields[e]) {
                    return this
                }
                var i = this.elements[e];
            ...
            key: "updateValidatorOption", value: function updateValidatorOption(e, t, i, s) {
            ...
            key: "setFieldOptions", value: function setFieldOptions(e, t) {
                this.fields[e] = t;
                return this
            }
        }, {
            ...
            key: "setLocale", value: function setLocale(e, t) {
                this.locale = e;
                this.localization = t;
                return this
            }
        }, {
            key: "waterfall", value: function waterfall(e) {
            ...
            key: "queryElements", value: function queryElements(e) {
            ...
            key: "normalizeResult", value: function normalizeResult(e, t, i) {
                var s = this.fields[e].validators[t];
                return Object.assign({}, i, {message: i.message || (s ? s.message : "") || (this.localization && this.localization[t] && this.localization[t]["default"] ? this.localization[t]["default"] : "") || "The field ".concat(e, " is not valid")})
            }
        }, {
            key: "toggleValidator", value: function toggleValidator(e, t, i) {
                var _this9 = this;
    ...
    var t$4 = function () {
        ...
        _createClass(t, [{
            key: "setCore", value: function setCore(_t2) {
                this.core = _t2;
                return this
            }
        }, {
    ...
    var e$4 = function (_t) {
        ...
        _createClass(e, [{
            ...
            key: "getValidatorName", value: function getValidatorName(t, _e) {
    ...
    var i$3 = function (_e) {
        ...
        _createClass(i, [{
            ...
            key: "onElementValidated", value: function onElementValidated(e) {
                if (e.valid) {
            ...
            key: "onFieldValid", value: function onFieldValid(e) {
            ...
            key: "onFieldInvalid", value: function onFieldInvalid(e) {
            ...
            key: "onMessageDisplayed", value: function onMessageDisplayed(e) {
    ...
    var t$3 = function (_e) {
        ...
        _createClass(t, [{
            ...
            key: "onFieldAdded", value: function onFieldAdded(e) {
                var _this3 = this;
                var _t2 = e.elements;
            ...
            key: "onFieldRemoved", value: function onFieldRemoved(e) {
            ...
            key: "createPluginInstance", value: function createPluginInstance(e, _t6) {
                var s = e.split(".");
                var a = window || this;
            ...
            key: "parsePlugins", value: function parsePlugins() {
                var _this5 = this;
            ...
            key: "isEmptyOption", value: function isEmptyOption(e) {
                var _t10 = e.validators;
                return Object.keys(_t10).length === 0 && _t10.constructor === Object
            }
        }, {
            key: "parseElement", value: function parseElement(e) {
            ...
            key: "normalizeValue", value: function normalizeValue(e) {
                return e === "true" ? true : e === "false" ? false : e
            }
        }, {
            key: "toUpperCase", value: function toUpperCase(e) {
                return e.charAt(1).toUpperCase()
            }
        }, {
            key: "toCamelCase", value: function toCamelCase(e) {
    ...
    var o = function (_t) {
        ...
        _createClass(o, [{
            ...
            key: "onFormValid", value: function onFormValid() {
                var t = this.core.getFormElement();
    ...
    var e$3 = function (_t) {
        ...
        _createClass(e, [{
            ...
            key: "onTriggerExecuted", value: function onTriggerExecuted(t) {
                if (this.opts[t.field]) {
                    var _e3 = this.opts[t.field].split(" ");
                    var _iterator = _createForOfIteratorHelper(_e3), _step;
                    try {
                        for (_iterator.s(); !(_step = _iterator.n()).done;) {
                            var _t2 = _step.value;
                            var _e4 = _t2.trim();
    ...
    var e$2 = function (_t) {
        ...
        _createClass(e, [{
            ...
            key: "ignoreValidation", value: function ignoreValidation(t, _e2, i) {
                return this.opts.excluded.apply(this, [t, _e2, i])
            }
        }], [{
            key: "defaultIgnore", value: function defaultIgnore(t, _e, i) {
    ...
    var t$2 = function (_e) {
        ...
        _createClass(t, [{
            ...
            key: "areFieldsValid", value: function areFieldsValid() {
            ...
            key: "onElementValidating", value: function onElementValidating(e) {
            ...
            key: "onElementNotValidated", value: function onElementNotValidated(e) {
                this.statuses.set(e.field, "NotValidated");
                this.opts.onStatusChanged(false)
            }
        }, {
            key: "onElementIgnored", value: function onElementIgnored(e) {
    ...
    var s$1 = function (_e) {
        ...
        _createClass(s, [{
            ...
            key: "prepareFieldContainer", value: function prepareFieldContainer(e, t) {
                var _this4 = this;
                if (t.length) {
            ...
            key: "prepareElementContainer", value: function prepareElementContainer(e, _s5, i) {
                var a;
            ...
            key: "onValidatorValidated", value: function onValidatorValidated(e) {
                var _s6 = e.elements;
            ...
            key: "onValidatorNotValidated", value: function onValidatorNotValidated(e) {
                var t = e.elements;
            ...
            key: "getClosestContainer", value: function getClosestContainer(e, t, _s) {
                var i = e;
                while (i) {
                    if (i === t) {
                        break
    ...
    var l = function (_e) {
        ...
        _createClass(l, [{
            ...
            key: "prepareElementContainer", value: function prepareElementContainer(e, i) {
            ...
            key: "removeClasses", value: function removeClasses(e, s) {
                var _this6 = this;
                var i = e.getAttribute("type");
    ...
    var i$2 = function (_e) {
        ...
        function i(e) {
            ...
            _this.icons = new Map;
            _this.opts = Object.assign({}, {
                invalid: "fv-plugins-icon--invalid", onPlaced: function onPlaced() {
                }, onSet: function onSet() {
                }, valid: "fv-plugins-icon--valid", validating: "fv-plugins-icon--validating"
            }, e);
            _this.elementValidatingHandler = _this.onElementValidating.bind(_assertThisInitialized(_this));
            _this.elementValidatedHandler = _this.onElementValidated.bind(_assertThisInitialized(_this));
            _this.elementNotValidatedHandler = _this.onElementNotValidated.bind(_assertThisInitialized(_this));
        ...
        _createClass(i, [{
            ...
            key: "prepareFieldIcon", value: function prepareFieldIcon(e, t) {
                var _this3 = this;
                if (t.length) {
            ...
            key: "prepareElementIcon", value: function prepareElementIcon(e, _i2) {
                ...
                var l = {
                    ...
                    }, element: _i2, field: e, iconElement: n
                };
            ...
            key: "setClasses", value: function setClasses(e, _i7, n, l) {
    ...
    var i$1 = function (_e) {
        ...
        _createClass(i, [{
            ...
            key: "shouldValidate", value: function shouldValidate(e, _i, t, l) {
            ...
            key: "clearInvalidFields", value: function clearInvalidFields(e) {
                var _this2 = this;
    ...
    var e = function (_t) {
        ...
        function e(t) {
            ...
            _this.opts = Object.assign({}, {
                aspNetButton: false, buttons: function buttons(t) {
        ...
        _createClass(e, [{
            ...
            key: "handleSubmitEvent", value: function handleSubmitEvent(t) {
                this.validateForm(t)
            }
        }, {
            key: "handleClickEvent", value: function handleClickEvent(t) {
            ...
            key: "validateForm", value: function validateForm(t) {
                var _this4 = this;
                t.preventDefault();
    ...
    var i = function (_t) {
        ...
        _createClass(i, [{
            ...
            key: "onIconPlaced", value: function onIconPlaced(t) {
                var _this2 = this;
            ...
            key: "onValidatorValidated", value: function onValidatorValidated(t) {
                if (!t.result.valid) {
                    var _e2 = t.elements;
            ...
            key: "onElementValidated", value: function onElementValidated(t) {
                if (t.valid) {
                    var _e3 = t.elements;
            ...
            key: "onDocumentClicked", value: function onDocumentClicked(t) {
                this.hide()
            }
        }, {
            key: "show", value: function show(t, _i3) {
                _i3.preventDefault();
                _i3.stopPropagation();
                ...
                var _this$tip$getBounding = this.tip.getBoundingClientRect(), l = _this$tip$getBounding.height,
    ...
    var t = function (_e) {
        ...
        _createClass(t, [{
            ...
            key: "prepareHandler", value: function prepareHandler(e, _t2) {
                var _this2 = this;
                _t2.forEach((function (_t3) {
                    var i = [];
            ...
            key: "handleEvent", value: function handleEvent(e, _t4, i) {
                var _this3 = this;
            ...
            key: "exceedThreshold", value: function exceedThreshold(e, _t7) {
