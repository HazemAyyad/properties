                        ...
                        <div class="card-body">
                            <form id="mainAdd" method="post" action="javascript:void(0)" >
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="price_monthly" id="price_monthly" placeholder="{{__('price monthly')}}" >
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label" for="price_yearly">{{__('price yearly')}}</label>
                                    <input type="text" class="form-control" name="price_yearly" id="price_yearly" placeholder="{{__('price yearly')}}" >
                                </div>
...
@section('scripts')
    ...
    <script>
        ...
        var data_url='{{ route('admin.plans.store')}}'
