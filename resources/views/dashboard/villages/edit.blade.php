    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{route('admin.directorates.index',$province->id)}}">{{$province->title}}|{{__('Directorates')}}</a>

                </li>
                <li class="breadcrumb-item active">{{__('Edit Directorate')}}</li>
                <!-- Basic table -->
            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">{{__('Edit Directorate')}}</h5>
                    </div>
                    <div class="card-body">
                                            ...
                                            <div id="accordion{{ $locale }}" class="accordion-collapse collapse @if ($index === 0) show @endif" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="name[{{ $locale }}]"  value="{{ $directorate->getTranslation('name', $locale) }}" id="title_{{ $locale }}" placeholder="{{ __('Title in ') . strtoupper($locale) }}" required>
                                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        var data_url='{{ route('admin.directorates.update',$directorate->id)}}'
