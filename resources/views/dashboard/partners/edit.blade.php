            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">{{__('Edit Partner')}}</h5>
                    </div>
                    <div class="card-body">
                        <form id="mainAdd" method="post" action="javascript:void(0)" >
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value="{{$partner->name}}" placeholder="{{__('Name')}}" required>
                            </div>


                            <div class="form-group mb-3">
                                <label class="form-label" for="link">{{__('Link')}}</label>
                                <input type="text" class="form-control" name="link" id="link" value="{{$partner->link}}" placeholder="{{__('Link')}}" >
                            </div>
                            <div class="form-group  mb-3">
...
@section('scripts')
    ...
    <script>
        ...
        var data_url='{{ route('admin.partners.update',$partner->id)}}'
