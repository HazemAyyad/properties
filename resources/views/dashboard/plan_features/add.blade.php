        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{__('Create Plan Feature')}}</li>
                    <!-- Basic table -->
                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">{{__('Create Plan Feature')}}</h5>
                        </div>
                        <div class="card-body">
                                                ...
                                                <div id="accordion{{ $locale }}" class="accordion-collapse collapse @if ($index === 0) show @endif" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="title[{{ $locale }}]"    id="title_{{ $locale }}" placeholder="{{ __('Titile in ') . strtoupper($locale) }}" required>
                                                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        var data_url='{{ route('admin.plan_features.store')}}'
