        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{__('Create Facility')}}</li>
                    <!-- Basic table -->
                            ...
                            <form id="mainAdd" method="post" action="javascript:void(0)" >
                                ...
                                <div class="col-md-6 mb-6">
                                    ...
                                    <select class="form-select" id="status" name="status"  >
                                        ...
                                        <option value="0" class="mb-2">{{__('Pending')}}</option>
                                        <option value="1" class="mb-2">{{__('Published')}}</option>
                                        <option value="2" class="mb-2">{{__('Draft')}}</option>
...
@section('scripts')
    ...
    <script>
        ...
        var data_url='{{ route('admin.property_facilities.store')}}'
