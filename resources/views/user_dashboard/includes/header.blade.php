        ...
        <div class="layout-wrap">
                                ...
                                <div class="header-account">
                                    ...
                                    <a href="#" class="box-avatar dropdown-toggle" data-bs-toggle="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('user.profile.upgrade.history') }}"><span class="icon icon-file-text me-2"></span>{{ __('Upgrade History') }}</a>
            ...
            <div class="sidebar-menu-dashboard">
                <ul class="box-menu-dashboard">
                    <li class="nav-menu-item {{ Route::is('user.dashboard') ? 'active' : '' }}"><a class="nav-menu-link" href="{{ route('user.dashboard') }}"><span class="icon icon-dashboard"></span> {{__('Dashboard')}}</a></li>
                    <li class="nav-menu-item {{ Route::is('user.properties.*') ? 'active' : '' }}"><a class="nav-menu-link" href="{{ route('user.properties.index') }}"><span class="icon icon-list-dashes"></span>{{__('My Properties')}}</a></li>
                    <li class="nav-menu-item {{ Route::is('user.invoices.*') ? 'active' : '' }}"><a class="nav-menu-link" href="{{ route('user.invoices.index') }}"><span class="icon icon-file-text"></span> {{__('My Invoices')}}</a></li>
                    <li class="nav-menu-item {{ Route::is('user.favorites.*') ? 'active' : '' }}"><a class="nav-menu-link" href="{{ route('user.favorites.index') }}"><span class="icon icon-heart"></span>{{__('My Favorites')}}</a></li>
                    <li class="nav-menu-item {{ Route::is('user.reviews.*') ? 'active' : '' }}"><a class="nav-menu-link" href="{{ route('user.reviews.index') }}"><span class="icon icon-review"></span> {{__('Reviews')}}</a></li>
                    <li class="nav-menu-item {{ Route::is('user.profile.*') ? 'active' : '' }}"><a class="nav-menu-link" href="{{ route('user.profile.index') }}"><span class="icon icon-profile"></span> {{ __('My Profile') }}</a></li>
                    <li class="nav-menu-item {{ Route::currentRouteName() === 'user.profile.upgrade.history' ? 'active' : '' }}"><a class="nav-menu-link" href="{{ route('user.profile.upgrade.history') }}"><span class="icon icon-file-text"></span> {{ __('Upgrade History') }}</a></li>
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    <div class="button-show-hide show-mb">
                        <span class="body-1" style="cursor: pointer;">{{__('Show Dashboard')}}</span>
                    </div>
